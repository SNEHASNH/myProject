...
<%  
   String type1=(String)session.getAttribute("account");
...
%>
<Tr><Td colspan=4 align=right><a href="nomine.jsp?acc1=<%=type1%>" style="font-size:15px">Nominee Details</a></td></tr>		
<tr><td align=right nowrap>Customer Code:</td><td>
<input type="text" name="customercode" value='<%=top%>' maxlength=7 readonly></td>
<td align=right nowrap>Profession</td><td>
<input type="text" name="profession" value=""></td></tr>
<tr><td align=right nowrap>Applicant No</td>
<td><input type="text" name="applnum" value="" maxlength=1 onkeypress="return blockkey(this)"></td>
<td align=right nowrap>Organization</td><td>
<input type="text" name="orgni" value=""></td></tr>
<tr><td align=right nowrap>Account No</td>
<td><input type="text" name="accnum" value="<%=type1%>" maxlength=8 readonly></td>
<td align=right nowrap>Working Since</td><td nowrap>
<input type="text" name="worksin" value="">*dd-mmm-yy</td></tr>
<tr><td align=right nowrap>Second Account No</td><td>
<input type="text" name="secondappno" value="" maxlength=8>(optional)</td>
<td align=right nowrap>Designation</td><td>
<input type="text" name="designation" value=""></td></tr>
<tr><td align=right nowrap>Cust FirstName</td><td>
<input type="text" name="ftname" value=""></td>
<td align=right nowrap>OFF Door_No</td><td>
<input type="text" name="offdoorno" value=""></td></tr>
<tr><td align=right nowrap>Cust MiddleName</td><td>
<input type="text" name="midname" value=""></td>
<td align=right nowrap>OFF Street</td><td>
<input type="text" name="offstreet" value=""></td></tr>
<tr><td align=right nowrap>Cust LastName</td><td>
<input type="text" name="lstname" value=""></td>
<td align=right nowrap>OFF Area</td><td>
<input type="text" name="offarea" value=""></td></tr>
<tr><td align=right nowrap>House No</td><td>
<input type="text" name="houseno" value=""></td>
<td align=right nowrap>OFF City</td><td>
<input type="text" name="offcity" value=""></td></tr>
<tr><td align=right nowrap>Street1</td><td>
<input type="text" name="street1" value=""></td>
<td align=right nowrap>OFF Pin</td><td>
<input type="text" name="offpin" value="" maxlength=6></td></tr>
<tr><td align=right nowrap>Street2</td><td>
<input type="text" name="street2" value=""></td>
<td align=right nowrap>OFF State Code </td><td>
<input type="text" name="offstatecd" value="" maxlength=2></td></tr>
<tr><td align=right nowrap>Area</td><td>
<input type="text" name="area" value=""></td>
<td align=right nowrap>OFF Phone_No</td><td>
<input type="text" name="offphone" value=""></td></tr>
<tr><td align=right nowrap>City</td><td>
<input type="text" name="city" value=""></td>
<td align=right nowrap>Pan Girn</td><td>
<input type="text" name="pangrin" value=""></td></tr>
<tr><td align=right nowrap>Pin No</td><td>
<input type="text" name="pin" value="" maxlength=6></td>
...
<input type="text" name="statecd" value="" maxlength=2></td>
<td align=right nowrap>Birth Date</td><td>
<input type="text" name="datebirth" value="">*dd-mmm-yy</td></tr>
<tr><td align=right nowrap>Res Phone</td><td>
<input type="text" name="resphn" value=""></td>
...
<input type="text" name="cellphn" value=""></td>
<td align=right nowrap>Relation Ship</td><td>
<input type="text" name="relshipapp" value=""></td></tr></tr>
...
<input type="text" name="eduquali" value=""></td></tr>
<tr><td align=right nowrap>No Years Residing At</td><td>
<input type="text" name="noyersadds" value="" maxlength=2 onkeypress="return blockkey(this)"></td>
<td align=right nowrap>Montly Income</td><td>
<input type="text" name="monthincome" value="" maxlength=6 onkeypress="return blockkey(this)"></td></tr>
<td align=right nowrap>GuardianName</td><td>
<input type="text" name="garname" value=""></td>
<td align=center nowrap colspan=2><button type="submit" accesskey="S"><u>S</u>ubmitt</button>&nbsp;&nbsp;
<button type="reset" accesskey="R"><u>R</u>eset</button></td><td></td></tr>
</td></tr></form></table>
